...
dji = pd.read_csv("D:\JunHill\Github\DQN-DDPG_Stock_Trading-master\save\^DJI.csv")
...
data_1 = pd.read_csv('D:\JunHill\Github\DQN-DDPG_Stock_Trading-master\save\dow_jones_30_daily_price.csv')
...
class StockTestEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        if self.terminal:
            plt.plot(self.asset_memory,'k')
            plt.plot(account_growth)
            plt.savefig('D:\JunHill\Github\DQN-DDPG_Stock_Trading-master\save\_test.png'.format(iteration))
            plt.close()
            ...
            print("Money: {}".format(self.state[0]))
