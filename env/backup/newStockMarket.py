...
data_1 = pd.read_csv(
    'D:\JunHill\Projects\stock_first_try\plot\dow_jones_30_daily_price.csv')
...
class megaStockEnv(gym.Env):
    ...
    def __init__(self, start_day=0, end_day=0, ticker_list=ticker_list, trading_days=1762, day=0, money=10000, algoMode=None):
        self.money = money
        self.day = day
        ...
        self.train_daily_data = train_daily_data
